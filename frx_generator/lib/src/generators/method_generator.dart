...
class MethodGenerator {
  static String generateMaybeWhen(String className, List<ConstructorInfo> constructors) {
  ...
  static String generateWhenOrNull(String className, List<ConstructorInfo> constructors) {
    final buffer = StringBuffer();
  ...
  static String generateMaybeMap(String className, List<ConstructorInfo> constructors) {
    final buffer = StringBuffer();
  ...
  static String generateMapOrNull(String className, List<ConstructorInfo> constructors) {
    final buffer = StringBuffer();
  ...
  static String generateWhen(String className, List<ConstructorInfo> constructors) {
    final buffer = StringBuffer();
  ...
  static String generateMap(String className, List<ConstructorInfo> constructors) {
